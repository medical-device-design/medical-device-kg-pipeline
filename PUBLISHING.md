...
Request from **Yaphet Kebede** — `kebedey@renci.org`, or DM on the OKN Slack. State the
...
|---|---|---|---|
| `Biomed-dev-graphdb` | 10.22.13.55 | **NIH R25** — bmedesign.org (Ajay) | original allocation |
| `Biomed-dev-graphdb-2` | 10.22.12.83 | **NSF subaward** — the KG (Prabhjot, Mustafa, Raham) | **185 GB / 172 GiB free** |

**`Biomed-dev-graphdb-2` is the build machine.** Alex expanded it on 29 June 2026 in response
